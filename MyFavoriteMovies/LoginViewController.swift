...
//2/3.    /* 2/3. Build the URL, Configure the request */
...
//7.        /* 7. Start the request */
    ...
    private func getSessionID(_ requestToken: String) {
        ...
        /* 6. Use the data! */
        print("now we've got the session ID. \(sessionID)")
    ...
    private func getUserID(_ sessionID: String) {
        ...
        let methodParameters = [
            Constants.TMDBParameterKeys.ApiKey : Constants.TMDBParameterValues.ApiKey,
            Constants.TMDBResponseKeys.SessionID : sessionID
        ]
